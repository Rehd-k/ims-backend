...
export class CategoryService {
    ...
    async createCategory(category: any, req: any) {
        try {
            ...
            log(`Error create  categories: ${error}`, "ERROR")
    ...
    async getCategoryById(CategoryId: string) {
        try {
            ...
            log(`Error deleting bank: ${error}`, "ERROR")
            throw new BadRequestException(error);
        }
    ...
    async update(id: string, updateProductDto: any): Promise<Category> {
        try {
            ...
            log(`Error updateing category: ${error}`, "ERROR")
    ...
    async remove(id: string): Promise<Category> {
        try {
            ...
            log(`Error remove  categories: ${error}`, "ERROR")
            throw new BadRequestException(error);
        }
    }
}
